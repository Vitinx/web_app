...
def gerar_arquivo_ap007b_criacao(df_cnpj, prefixo_mes, data_nome_arquivo, data_inicio_assinatura, data_fim_assinatura, numero_arquivo):
    ...
    instituicao_credenciadora = df_cnpj['instituicao_credenciadora'] # Todas as credenciadoras, criar código para trazer o histórico das que pagam em cada CNPJ
    ...
    titular = df_cnpj['CNPJ'] # CNPJ do cliente
    regras_de_divisao = '1' # Comprometimento de valor definido
    valor_a_onerar = df_cnpj['VALOR'] # Valor da mensalidade
    ...
    df_ap007b.to_csv(f'data/arquivos_entrada/AP_007B/{nome_arquivo}.gz', header=None, sep=';', index=False)
