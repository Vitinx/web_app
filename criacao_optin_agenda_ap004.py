...
def gerar_arquivo_ap004_criacao(df_cnpj, prefixo_mes, data_nome_arquivo, data_inicio_assinatura, data_fim_assinatura, numero_arquivo):
    ...
    data_de_inicio_agenda = data_inicio_assinatura  # Data de início da assinatura
    data_de_fim_agenda = data_fim_assinatura  # Data de fim da assinatura
    ...
    df_ap004.to_csv(f'data/arquivos_entrada/AP_004/{nome_arquivo}.gz', header=None, sep=';', index=False)
