...
def gerar_arquivo_ap004_atualizacao(df_cnpj, prefixo_mes, data_nome_arquivo, data_de_inicio, data_de_fim, numero_arquivo):
    
    # Criando os campos do relatório
    tipo_de_operacao_a = 'A'  # Criar contrato
    ...
    dados = {
        'tipo_de_operacao': tipo_de_operacao_a,
